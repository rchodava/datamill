...
/**
 * From: https://github.com/h2database/h2database/blob/193ce9105e2de773c0ab62855a000cb61e9ee0e0/h2/src/main/org/h2/mode/FunctionsMySQL.java
 *
...
public class FunctionsMySQL {
    ...
    private static String convertToSimpleDateFormat(String format) {
        ...
        for (int i = 0; i < replace.length; i += 2) {
            format = replaceAll(format, replace[i], replace[i + 1]);
        }
        return format;
    }
